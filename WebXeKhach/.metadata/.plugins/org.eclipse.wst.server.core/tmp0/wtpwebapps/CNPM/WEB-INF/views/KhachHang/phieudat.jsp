...
<head>
    ...
    <body class="">
                ...
                <div class="row">
                                ...
                                <div class="top-menu-item">
                                    <div class="dropdown wheel-user-ico">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="user-password.html">Đổi mật khẩu</a></li>
                                            <li><a href="user-ticket.html">Vé đặt</a></li>
                                            <li><a>Đăng xuất</a></li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-9 ">
                        <div class="wheel-navigation">
                            ...
                            <a href="reservation.html" class="wheel-cheader-but" target="_blank">Đặt vé ngay</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table datatable ">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>410</td>
                                    <td>
                                      <a href="hoadon.html" class="fa fa-eye"></a>
        ...
        <!-- google maps -->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBt5tJTim4lOO3ojbGARhPd1Z3O3CnE-C8"
        ...
        <!-- sixth block end -->
        <script src="resources/KhachHang/assets/vendor/apexcharts/apexcharts.min.js"></script>
        <script src="resources/KhachHang/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
        ...
        <script src="resources/KhachHang/assets/vendor/simple-datatables/simple-datatables.js"></script>
        <script src="resources/KhachHang/assets/vendor/tinymce/tinymce.min.js"></script>
        <script src="resources/KhachHang/assets/vendor/php-email-form/validate.js"></script>
